...
// defines if UDP_HIL_MS5611 and/or any timing experiment is enabled
#include "AP_HAL_Linux/Experiments.h"

#ifdef UDP_HIL_MS5611
...
#include <time.h>
struct timespec MS5611_CallPrecision_nanos;
struct timespec MS5611_CallPrecision_prev_nanos;
#endif
